...
class Other(APIView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            return response_success_200(status=STATUS_PHONE_NUMBER_ERROR, message='参数错误或手机号不合法')
