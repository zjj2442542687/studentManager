...
from user_details.views.user_details_select import UserDetailsSelectView, UserDetailsPaginationSelectView
...
urlpatterns = [
    ...
    # 获得所有用户详情信息
    path("getAll", UserDetailsPaginationSelectView.as_view({'get': 'list'})),
    # 根据id获得用户详情信息
    ...
    # 根据用户token获得用户详情信息
    path("getUserDetailsByToken", UserDetailsSelectView.as_view({'get': 'retrieve_by_token'})),

    # 根据token修改用户详情信息
    path("FileInfo", UserDetailsOtherView.as_view({'patch': 'partial_update'})),
